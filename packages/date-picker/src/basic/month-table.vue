...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'modify-person-ui/src/utils/date-util';
  import { hasClass } from 'modify-person-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'modify-person-ui/src/utils/util';
