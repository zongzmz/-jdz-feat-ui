...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'modify-person-ui/src/utils/date-util';
  import ElScrollbar from 'modify-person-ui/packages/scrollbar';
  import RepeatClick from 'modify-person-ui/src/directives/repeat-click';
